...
# Enable debug output to see connection details
rtr-validator -s "rtr.nxthdr.dev:3323" -p "1.1.1.0/24" --debug
...
- `-d, --debug` - Enable debug output showing connection and sync details
